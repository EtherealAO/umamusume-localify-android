...
GetRuntimeType(const char *assemblyName, const char *namespaze, const char *klassName)
{
    ...
    auto(*get_type)(Il2CppObject * thisObj) = reinterpret_cast<Il2CppObject *(*)(Il2CppObject * thisObj)>(il2cpp_symbols::get_method_pointer("mscorlib.dll", "System",
                                                                                                                                             "Object", "GetType", 0));
...
Il2CppObject *ParseEnum(Il2CppObject *runtimeType, const string &name)
{
    return reinterpret_cast<Il2CppObject *(*)(Il2CppObject *,
                                              Il2CppString *)>(il2cpp_symbols::get_method_pointer("mscorlib.dll", "System", "Enum", "Parse", 2))(runtimeType,
...
Il2CppString *GetEnumName(Il2CppObject *runtimeType, int id)
{
    return reinterpret_cast<Il2CppString *(*)(Il2CppObject *,
                                              Int32Object *)>(il2cpp_symbols::get_method_pointer("mscorlib.dll", "System", "Enum", "GetName", 2))(runtimeType, GetInt32Instance(id));
}
...
Il2CppObject *GetCustomTMPFontFallback()
{
    ...
    if (font)
    {
        return reinterpret_cast<Il2CppObject *(*)(Il2CppObject * font, int samplingPointSize, int atlasPadding, int renderMode,
            ...
            il2cpp_symbols::get_method_pointer("Unity.TextMeshPro.dll", "TMPro",
                                               "TMP_FontAsset", "CreateFontAsset", 1))(font, 36, 4, 4165, 8192, 8192, 1, false);
    }
    return nullptr;
}
...
Il2CppString *localizeextension_text_hook(int id)
{
    auto orig_result = reinterpret_cast<decltype(localizeextension_text_hook) *>(localizeextension_text_orig)(
        id);
    auto result = g_static_entries_use_text_id_name ? localify::get_localized_string(GetTextIdNameById(id)) : g_static_entries_use_hash ? localify::get_localized_string(orig_result)
...
void TextMeshProUguiCommon_Awake_hook(Il2CppObject *_this)
{
    ...
    auto colorEnum = reinterpret_cast<int (*)(Il2CppObject *)>(il2cpp_class_get_method_from_name(
                                                                   _this->klass, "get_OutlineColor", 0)
                                                                   ->methodPointer)(_this);
    ...
    reinterpret_cast<void (*)(Il2CppObject *, Il2CppObject *)>(il2cpp_class_get_method_from_name(
                                                                   _this->klass, "set_font", 1)
                                                                   ->methodPointer)(_this, customFont);
...
void GallopUtil_GotoTitleOnError_hook(Il2CppString *text)
{
    ...
    dialogData = reinterpret_cast<Il2CppObject *(*)(Il2CppObject * thisObj,
        ...
        il2cpp_class_get_method_from_name(dialogData->klass, "SetSimpleOneButtonMessage",
                                          4)
            ->methodPointer)(dialogData, errorText,
    ...
    errorDialog = reinterpret_cast<Il2CppObject *(*)(Il2CppObject * data,
                                                     bool isEnableOutsideClick)>(il2cpp_symbols::get_method_pointer("umamusume.dll", "Gallop", "DialogManager", "PushSystemDialog", 2))(dialogData, true);
}
...
Il2CppString *GeneratePushNotifyCharaIconPng_hook(Il2CppObject *thisObj, int unitId, int dressId,
                                                  Boolean forceGen)
{
    return reinterpret_cast<decltype(GeneratePushNotifyCharaIconPng_hook) *>(GeneratePushNotifyCharaIconPng_orig)(
...
{
    reinterpret_cast<decltype(MasterDataManager_ctor_hook) *>(MasterDataManager_ctor_orig)(thisObj);
                                         ...
                                         int id)
{
    ...
    reinterpret_cast<decltype(SendNotificationWithExplicitID_hook) *>(SendNotificationWithExplicitID_orig)(
...
void hookMethods()
{
    ...
    auto wait_resize_ui_addr = reinterpret_cast<void (*)(Il2CppObject * thisObj, bool isPortrait,
                                                         bool isShowOrientationGuide)>(il2cpp_symbols::get_method_pointer("umamusume.dll", "Gallop", "UIManager", "WaitResizeUI", 2));
    ...
    auto apply_graphics_quality_addr = reinterpret_cast<void (*)(
        Il2CppObject *, Il2CppObject *, bool)>(il2cpp_symbols::get_method_pointer("umamusume.dll",
                                                                                  "Gallop",
    ...
    auto GraphicSettings_GetVirtualResolution3D_addr = reinterpret_cast<Vector2Int_t (*)(
        Il2CppObject *, bool)>(il2cpp_symbols::get_method_pointer("umamusume.dll",
                                                                  "Gallop",
                                                                  "GraphicSettings", "GetVirtualResolution3D", 1));

    auto ChangeScreenOrientation_addr = reinterpret_cast<void (*)(
        ScreenOrientation, bool)>(il2cpp_symbols::get_method_pointer("umamusume.dll",
                                                                     "Gallop",
    ...
    auto WaitDeviceOrientation_addr = reinterpret_cast<void (*)(
        ScreenOrientation)>(il2cpp_symbols::get_method_pointer("umamusume.dll",
                                                               "Gallop", "Screen", "WaitDeviceOrientation", 1));

    auto CanvasScaler_set_referenceResolution_addr = reinterpret_cast<void (*)(Il2CppObject *,
                                                                               float)>(il2cpp_symbols::get_method_pointer("UnityEngine.UI.dll",
    ...
    auto SafetyNet_GetSafetyNetStatus_addr = reinterpret_cast<void (*)(Il2CppObject *,
                                                                       float)>(il2cpp_symbols::get_method_pointer("Cute.Core.Assembly.dll",
    ...
    auto MoviePlayerForUI_AdjustScreenSize_addr = reinterpret_cast<void (*)(Il2CppObject *,
                                                                            Vector2_t,
                                                                            bool)>(il2cpp_symbols::get_method_pointer("Cute.Cri.Assembly.dll", "Cute.Cri", "MoviePlayerForUI", "AdjustScreenSize", 2));

    auto MoviePlayerForObj_AdjustScreenSize_addr = reinterpret_cast<void (*)(Il2CppObject *,
                                                                             Vector2_t,
                                                                             bool)>(il2cpp_symbols::get_method_pointer("Cute.Cri.Assembly.dll", "Cute.Cri", "MoviePlayerForObj", "AdjustScreenSize", 2));
    ...
    auto FrameRateController_OverrideByMaxFrameRate_addr = reinterpret_cast<void (*)(Il2CppObject *,
                                                                                     int)>(il2cpp_symbols::get_method_pointer("umamusume.dll", "Gallop", "FrameRateController", "OverrideByMaxFrameRate", 1));

    auto FrameRateController_ResetOverride_addr = reinterpret_cast<void (*)(Il2CppObject *,
                                                                            int)>(il2cpp_symbols::get_method_pointer("umamusume.dll", "Gallop", "FrameRateController", "ResetOverride", 1));

    auto FrameRateController_ReflectionFrameRate_addr = reinterpret_cast<void (*)(Il2CppObject *,
                                                                                  int)>(il2cpp_symbols::get_method_pointer("umamusume.dll", "Gallop", "FrameRateController", "ReflectionFrameRate", 0));
    ...
    auto assetbundle_unload_addr = reinterpret_cast<Il2CppObject *(*)(Il2CppObject *)>(il2cpp_symbols::get_method_pointer(
    ...
    if (!assets && !g_font_assetbundle_path.empty() && g_replace_to_custom_font)
    {
        ...
        {
            assetbundlePath.insert(0, u16string(u"/sdcard/Android/data/").append(localify::u8_u16(Game::GetCurrentPackageName())).append(u"/"));
        }
...
#pragma endregion
    ...
    if (Game::currentGameRegion == Game::Region::KOR && g_restore_notification && false)
    {
        ...
        createFavIconFilePath = reinterpret_cast<Il2CppString *(*)(Il2CppObject *, int)>(il2cpp_symbols::get_method_pointer("umamusume.dll",
                                                                                                                            "Gallop",
                                                                                                                            "PushNotificationManager",
        ...
        auto SendNotificationWithExplicitID_addr = reinterpret_cast<void (*)(
            Il2CppObject *)>(il2cpp_symbols::get_method_pointer("Unity.Notifications.Android.dll",
        ...
        auto GeneratePushNotifyCharaIconPng_addr = reinterpret_cast<void (*)(
            Il2CppObject *, int, int, Boolean)>(il2cpp_symbols::get_method_pointer("umamusume.dll",
                                                                                   "Gallop",
                                                                                   "PushNotificationManager",
...
void il2cpp_load_assetbundle()
{
    ...
    if (replaceAssets)
    {
        ...
        auto resources_load_addr = reinterpret_cast<Il2CppObject *(*)(Il2CppString * path,
                                                                      Il2CppType *)>(il2cpp_symbols::get_method_pointer("UnityEngine.CoreModule.dll", "UnityEngine", "Resources", "Load", 2));

        auto Sprite_get_texture_addr = reinterpret_cast<Il2CppObject *(*)(Il2CppObject *)>(il2cpp_resolve_icall(
            "UnityEngine.Sprite::get_texture(UnityEngine.Sprite)"));

        auto Renderer_get_material_addr = reinterpret_cast<Il2CppObject *(*)(Il2CppObject *)>(il2cpp_symbols::get_method_pointer("UnityEngine.CoreModule.dll",
                                                                                                                                 "UnityEngine", "Renderer",
                                                                                                                                 "get_material", 0));

        auto Renderer_get_materials_addr = reinterpret_cast<Il2CppObject *(*)(Il2CppObject *)>(il2cpp_symbols::get_method_pointer("UnityEngine.CoreModule.dll",
                                                                                                                                  "UnityEngine", "Renderer",
                                                                                                                                  "get_materials", 0));

        auto Renderer_get_sharedMaterial_addr = reinterpret_cast<Il2CppObject *(*)(Il2CppObject *)>(il2cpp_symbols::get_method_pointer("UnityEngine.CoreModule.dll",
                                                                                                                                       "UnityEngine", "Renderer",
                                                                                                                                       "get_sharedMaterial", 0));

        auto Renderer_get_sharedMaterials_addr = reinterpret_cast<Il2CppObject *(*)(Il2CppObject *)>(il2cpp_symbols::get_method_pointer("UnityEngine.CoreModule.dll",
                                                                                                                                        "UnityEngine", "Renderer",
                                                                                                                                        "get_sharedMaterials", 0));

        auto Renderer_set_material_addr = reinterpret_cast<Il2CppObject *(*)(Il2CppObject *)>(il2cpp_symbols::get_method_pointer("UnityEngine.CoreModule.dll",
                                                                                                                                 "UnityEngine", "Renderer",
                                                                                                                                 "set_material", 1));

        auto Renderer_set_materials_addr = reinterpret_cast<Il2CppObject *(*)(Il2CppObject *)>(il2cpp_symbols::get_method_pointer("UnityEngine.CoreModule.dll",
                                                                                                                                  "UnityEngine", "Renderer",
                                                                                                                                  "set_materials", 1));

        auto Renderer_set_sharedMaterial_addr = reinterpret_cast<Il2CppObject *(*)(Il2CppObject *)>(il2cpp_symbols::get_method_pointer("UnityEngine.CoreModule.dll",
                                                                                                                                       "UnityEngine", "Renderer",
                                                                                                                                       "set_sharedMaterial", 1));

        auto Renderer_set_sharedMaterials_addr = reinterpret_cast<Il2CppObject *(*)(Il2CppObject *)>(il2cpp_symbols::get_method_pointer("UnityEngine.CoreModule.dll",
                                                                                                                                        "UnityEngine", "Renderer",
                                                                                                                                        "set_sharedMaterials", 1));

        auto Material_get_mainTexture_addr = reinterpret_cast<Il2CppObject *(*)(Il2CppObject *)>(il2cpp_symbols::get_method_pointer("UnityEngine.CoreModule.dll",
                                                                                                                                    "UnityEngine", "Material",
                                                                                                                                    "get_mainTexture", 0));

        auto Material_set_mainTexture_addr = reinterpret_cast<Il2CppObject *(*)(Il2CppObject *)>(il2cpp_symbols::get_method_pointer("UnityEngine.CoreModule.dll",
                                                                                                                                    "UnityEngine", "Material",
                                                                                                                                    "set_mainTexture", 1));
        ...
        auto CharaPropRendererAccessor_SetTexture_addr = reinterpret_cast<Il2CppObject *(*)(Il2CppObject *)>(il2cpp_symbols::get_method_pointer("umamusume.dll", "Gallop",
